...
const logoPositions: Record<number, number> = {
	0: 0, // PVV
	1: 8.69565, // VVD
	2: 26.087, // CDA
	3: 47.8261, // SGP
...
export function getLogoStyle(logoIndex: number | null | undefined): string {
...
export function getLogoPosition(logoIndex: number | null | undefined): string {
