  ...
  <header class="bg-white/90 backdrop-blur-lg border-b border-gray-200/50 sticky top-0 z-50">
    <div class="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
      <div class="flex flex-col gap-3 sm:gap-0 sm:flex-row sm:items-center sm:justify-between">
        <h1 on:keypress={() => step = 1} on:click={() => step = 1} class=" cursor-pointer text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent text-center sm:text-left">
          Partijwijzer
        </h1>
